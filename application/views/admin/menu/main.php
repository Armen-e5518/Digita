<div class="n_titleBl">
    <h1><?=$labels->$mod.' &raquo; "'. $menu['name'] .'" '. $labels->list;?></h1>
    <a href="<?=site_url('/admin/menu/edit/'. $id .'/0');?>" class="n_add">+ <?php echo $labels->add;?></a>
</div>
<div class="n_backWrap">
    <a href="<?=site_url('/admin/menu/');?>" class="n_back"><i class="fa fa-long-arrow-left"></i> <?= $labels->back; ?></a>
</div>
<div class="clr">
...
<ul class="table-style-head">
    <li>
        ...
        <div class="WidthPercent10">
            <div class="<?= isset($order_key) && $order_key == 'Status_' ? 'active-order-col' : '' ?>">
                <a href="javascript:void(0);" class="for-list-ordering"><strong>Status</strong></a>
            </div>
        </div>
...
<?php 
	...
	?>
		<div style='text-align:center;'>
			...
			<span class="icon-but save_menu"><i class="fa fa-refresh"></i> <?=$labels->confirm_the_changes;?></span>
		</div>
	<?php 
	}	 
?>